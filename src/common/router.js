...
export const getRouterData = (app) => {
 const routerConfig = {
   ...
   '/contract/products':{
     component:dynamicWrapper(app, ['products','exchanges','sessions_in_products'], () => import('../routes/Contract/Products'))

   },
   '/contract/vcontracts':{
     component:dynamicWrapper(app, ['vcontracts','vcontract_groups'], () => import('../routes/Contract/Vcontracts'))
   ...
   '/trading_systems/vcontract_groups':{
     component:dynamicWrapper(app, ['vcontract_groups','vcontracts_in_groups'], () => import('../routes/Trading_systems/Vcontract_groups'))

   },
   '/trading_calendars':{
     component:dynamicWrapper(app, [], () => import('../routes/Trading_calendars/Trading_calendars'))

   },
   '/trade_sessions':{
     component:dynamicWrapper(app, ['trade_sessions'], () => import('../routes/Trade_sessions/Trade_sessions'))
