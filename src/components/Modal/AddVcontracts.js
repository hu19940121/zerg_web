  ...
  return (
    ...
    <Row gutter={10}>
    {
      isadd &&(<Col xl={12} lg={24} md={24} sm={24} xs={24}>
          ...
          <FormItem label="交易所中的编码" style={FormItemStyle}  hasFeedback labelCol={{ span: 11, }} wrapperCol={{ span: 13}}>
      ...
      <Col xl={12} lg={24} md={24} sm={24} xs={24}>
       ...
       <FormItem label="合约编码" style={FormItemStyle} hasFeedback labelCol={{ span: 9 }} wrapperCol={{ span:15}}>
